...
namespace :import_word_heritages do
  ...
  task :v2_run => :environment do
    path = Pathname.new('world_heritages_list_v2.csv').expand_path
    ...
    # puts row['name_fr']
      word_heritage = ::WorldHeritage.new(
        ...
        justification_en: row['justification_en'] ? row['justification_en'] : nil,
        justification_fr: row['justification_fr'] ? row['justification_fr'] : nil,
        date_inscribed: row['date_inscribed'],
        secondary_dates: row['secondary_dates'],
        danger: row['danger'],
        longitude: row['longitude'],
        ...
        states_name_en: row['states_name_en'],
        states_name_fr: row['states_name_fr'],
        states_name_zh: row['states_name_zh'],
        region_en: row['region_en'],
        region_fr: row['region_fr'],
